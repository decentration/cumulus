...
#[sc_tracing::logging::prefix_logs_with("Statemine Parachain")]
async fn start_statemine_node_impl<RuntimeApi, RB, BIQ, BIC>(
	parachain_config: Configuration,
	polkadot_config: Configuration,
	collator_options: CollatorOptions,
	para_id: ParaId,
	...
	) -> Result<Box<dyn ParachainConsensus<Block>>, sc_service::Error>,
{
	...
	let rpc_builder = {
		...
		Box::new(move |deny_unsafe, _| {
			...
			rpc::create_full_statemine(deps, backend_for_rpc.clone()).map_err(Into::into)
		})
	};
